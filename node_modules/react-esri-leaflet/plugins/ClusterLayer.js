...
const esri_leaflet_cluster_1 = require("esri-leaflet-cluster");
const core_1 = require("@react-leaflet/core");
const createEsriLayer = (props, context) => {
    const instance = (0, esri_leaflet_cluster_1.default)({
        ...props,
    });
 ...
 */
const ClusterLayer = (0, core_1.createLayerComponent)(createEsriLayer, updateEsriLayer);
